import{i as e,s as t}from"./preload-helper-B-rJVKt8.js";import{M as n,N as r,S as i,g as a,h as o,j as s,k as c,n as l,t as u,x as d}from"./iframe-Blc3RJWa.js";import{_ as f,b as p,g as m,h,n as g,t as _}from"./button-Dr2mjWNP.js";import{a as ee,c as v,i as te,n as y,o as b,r as x,s as S,t as C}from"./input-BMYHataF.js";var w,T,E=e((()=>{w=t(r(),1),T=(0,w.createContext)(null)})),D,O,k,A,j,M,N=e((()=>{D=n(),f(),O=t(r(),1),a(),E(),h(),d(),g(),v(),y(),k=s(),A=(e,t)=>{let n=(0,D.c)(4),[r,i]=(0,O.useState)(e),a,o;return n[0]!==t||n[1]!==e?(a=()=>{let n=setTimeout(()=>i(e),t);return()=>clearTimeout(n)},o=[e,t],n[0]=t,n[1]=e,n[2]=a,n[3]=o):(a=n[2],o=n[3]),(0,O.useEffect)(a,o),r},j={RESTAURANT:`음식점`,CAFE:`카페`,FASHION:`패션`,BEAUTY:`뷰티`,ETC:`기타`},M=()=>{let{storeQuery:e}=m(o),{storeId:t,eventId:n,setStore:r,setEvent:a}=m(T),{toSubmit:s}=i(),[c,l]=(0,O.useState)(``),u=A(c,300),{storeList:d,isLoading:f}=e.useGetStores({name:u}),{eventList:h}=e.useGetStoreEvents({storeId:t}),g=d?.stores??[],v=g.find(e=>e.id===t),y=h?.events??v?.events??[];return(0,k.jsxs)(`div`,{className:`space-y-6`,children:[(0,k.jsx)(`h1`,{className:`font-semibold text-xl`,children:`가게 검색`}),(0,k.jsxs)(`div`,{className:`relative`,children:[(0,k.jsx)(p,{className:`pointer-events-none absolute top-1/2 left-2.5 size-4 -translate-y-1/2 text-muted-foreground`}),(0,k.jsx)(C,{placeholder:`가게 이름을 검색하세요`,value:c,onChange:e=>{l(e.target.value)},className:`pl-8`})]}),f?(0,k.jsx)(`p`,{className:`py-8 text-center text-muted-foreground text-sm`,children:`검색 중...`}):g.length===0?(0,k.jsx)(`p`,{className:`py-8 text-center text-muted-foreground text-sm`,children:`검색 결과가 없습니다.`}):(0,k.jsx)(`div`,{className:`space-y-2`,children:g.map(e=>(0,k.jsx)(`button`,{type:`button`,className:`w-full text-left`,onClick:()=>{r(e.id)},children:(0,k.jsx)(x,{className:`cursor-pointer transition-colors hover:ring-primary/50 ${t===e.id?`ring-2 ring-primary`:``}`,children:(0,k.jsxs)(b,{children:[(0,k.jsxs)(`div`,{className:`flex items-start justify-between gap-2`,children:[(0,k.jsx)(S,{children:e.name}),(0,k.jsx)(`span`,{className:`shrink-0 rounded-full bg-muted px-2 py-0.5 text-muted-foreground text-xs`,children:j[e.category]??e.category})]}),(0,k.jsx)(ee,{children:e.address})]})})},e.id))}),t!==null&&(0,k.jsxs)(`div`,{className:`space-y-3`,children:[(0,k.jsxs)(`h2`,{className:`font-medium text-base`,children:[v?.name,`의 이벤트`]}),y.length===0?(0,k.jsx)(`p`,{className:`text-muted-foreground text-sm`,children:`등록된 이벤트가 없습니다.`}):(0,k.jsx)(`div`,{className:`space-y-2`,children:y.filter(e=>e.isActive).map(e=>(0,k.jsx)(`button`,{type:`button`,className:`w-full text-left`,onClick:()=>{a(e.id)},children:(0,k.jsxs)(x,{className:`cursor-pointer transition-colors hover:ring-primary/50 ${n===e.id?`ring-2 ring-primary`:``}`,children:[(0,k.jsx)(b,{children:(0,k.jsxs)(`div`,{className:`flex items-start justify-between gap-2`,children:[(0,k.jsx)(S,{children:e.title}),(0,k.jsxs)(`span`,{className:`shrink-0 font-semibold text-primary text-sm`,children:[e.reward,` ETH`]})]})}),(0,k.jsx)(te,{children:(0,k.jsx)(`p`,{className:`text-muted-foreground text-sm`,children:e.condition})})]})},e.id))})]}),(0,k.jsx)(_,{className:`w-full`,disabled:t===null||n===null,onClick:s,children:`다음 단계`})]})},M.__docgenInfo={description:``,methods:[],displayName:`StoreSearch`}})),P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{P=n(),u(),F=t(r(),1),E(),N(),I=s(),{expect:L,userEvent:R,waitFor:z,within:B}=__STORYBOOK_MODULE_TEST__,V=`기절초풍왕순대`,H=`신규 메뉴 불닭볶음면 먹고 리뷰 달기`,U=()=>{let e=(0,P.c)(7),[t,n]=(0,F.useState)(null),[r,i]=(0,F.useState)(null),a;e[0]===Symbol.for(`react.memo_cache_sentinel`)?(a=e=>{n(e),i(null)},e[0]=a):a=e[0];let o;e[1]!==r||e[2]!==t?(o={storeId:t,eventId:r,setStore:a,setEvent:i},e[1]=r,e[2]=t,e[3]=o):o=e[3];let s;e[4]===Symbol.for(`react.memo_cache_sentinel`)?(s=(0,I.jsx)(M,{}),e[4]=s):s=e[4];let c;return e[5]===o?c=e[6]:(c=(0,I.jsx)(T.Provider,{value:o,children:s}),e[5]=o,e[6]=c),c},W={title:`Landing/StoreSearch`,component:U},G=async(e,t=V)=>{let n=await e.findByText(t);await R.click(n)},K={name:`200 가게 목록 로드`,play:async({canvasElement:e})=>{let t=B(e);await L(t.findByText(V)).resolves.toBeInTheDocument(),await L(t.findByText(`어저구 베이커리`)).resolves.toBeInTheDocument()}},q={name:`200 가게 선택 후 이벤트 표시`,play:async({canvasElement:e})=>{let t=B(e);await G(t),await L(t.findByText(H)).resolves.toBeInTheDocument()}},J={name:`200 가게·이벤트 선택 후 다음 단계 활성화`,play:async({canvasElement:e})=>{let t=B(e);await G(t);let n=await t.findByText(H);await R.click(n),L(t.getByRole(`button`,{name:`다음 단계`})).not.toBeDisabled()}},Y={name:`200 검색어로 가게 필터링`,play:async({canvasElement:e})=>{let t=B(e);await L(t.findByText(`어저구 베이커리`)).resolves.toBeInTheDocument();let n=t.getByPlaceholderText(`가게 이름을 검색하세요`);await R.type(n,`순대`),await z(()=>L(t.queryByText(`어저구 베이커리`)).not.toBeInTheDocument(),{timeout:2e3}),await z(()=>L(t.getByText(V)).toBeInTheDocument(),{timeout:2e3}),L(t.queryByText(`어저구 베이커리`)).not.toBeInTheDocument()}},X={name:`검색 결과 없음`,play:async({canvasElement:e})=>{let t=B(e);await t.findByText(V);let n=t.getByPlaceholderText(`가게 이름을 검색하세요`);await R.type(n,`없는가게이름`),await L(t.findByText(`검색 결과가 없습니다.`)).resolves.toBeInTheDocument()}},Z={name:`500 가게 목록 조회 실패`,parameters:{msw:{handlers:[l.get(`*/api/store`,()=>c.json({code:`SERVER_ERROR`,message:`Internal server error`},{status:500}))]}},play:async({canvasElement:e})=>{await L(B(e).findByText(`검색 결과가 없습니다.`)).resolves.toBeInTheDocument()}},Q={name:`404 이벤트 목록 조회 실패`,parameters:{msw:{handlers:[l.get(`*/api/store`,()=>c.json({stores:[{id:`store-001`,name:V,address:`서울특별시 관악구 봉천동 1620-38`,category:`RESTAURANT`,description:`이 순대를 먹으면 기절해요.`,events:[],totalEventCount:0}],totalCount:1,currentPage:0,totalPages:1,hasNext:!1})),l.get(`*/api/store/:storeId/events`,()=>c.json({code:`STORE_001`,message:`Store not found`},{status:404}))]}},play:async({canvasElement:e})=>{let t=B(e);await G(t),await L(t.findByText(`등록된 이벤트가 없습니다.`)).resolves.toBeInTheDocument()}},K.parameters={...K.parameters,docs:{...K.parameters?.docs,source:{originalSource:`{
  name: '200 가게 목록 로드',
  play: async ({
    canvasElement
  }) => {
